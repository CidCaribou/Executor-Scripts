...
.switch.toggled .slider {
  background-color: black;
}

.switch.toggled .slider .sun-moon {
...
.switch.toggled .slider .sun-moon .moon-dot {
  opacity: 1;
}
...
function invertColors() {
    document.querySelectorAll('*:not([invTouch]):not(.switch):not(.switch *):not(#executor-menu):not(#executor-menu *)').forEach((element) => {
