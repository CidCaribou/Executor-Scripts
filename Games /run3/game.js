...
const htmlFileURL = 'https://htmlpreview.github.io/?https://cdn.jsdelivr.net/gh/CidCaribou/Executor-Scripts@main/Games%20/run3/index.html';
iframe.src = htmlFileURL;
iframe.onload = () => {
  title.textContent = 'Run 3';
};
