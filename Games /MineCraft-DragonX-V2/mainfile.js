...
const loadHTMLContent = async (url) => {
  try {
    ...
    title.textContent = 'DragonX V2 International';
  } catch (error) {
...
const htmlFileURL = 'https://raw.githubusercontent.com/CidCaribou/Executor-Scripts/refs/heads/main/Games%20/MineCraft-DragonX-V2/DragonX_V2_International.html';
