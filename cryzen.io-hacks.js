Swal.fire({
    title: 'Success!',
    text: 'Scripts loaded successfully! Press right-shift to toggle the menu.',
    icon: 'success',
...
(() => {
                ...
                e.exports = function(e) {
                    ...
                    return t.toString = function() {
                        ...
                        for (var c = 0; c < e.length; c++) {
                            var d = [].concat(e[c]);
                            i && s[d[0]] || (void 0 !== o && (void 0 === d[5] || (d[1] = "@layer".concat(d[5].length > 0 ? " ".concat(d[5]) : "", " {").concat(d[1], "}")), d[5] = o), n && (d[2] ? (d[1] = "@media ".concat(d[2], " {").concat(d[1], "}"), d[2] = n) : d[2] = n), a && (d[4] ? (d[1] = "@supports (".concat(d[4], ") {").concat(d[1], "}"), d[4] = a) : d[4] = "".concat(a)), t.push(d))
                        }
                    }, t
                }
            },
            ...
            72: e => {
                ...
                e.exports = function(e, a) {
                    ...
                    return function(e) {
                        ...
                        for (var l = i(e, a), c = 0; c < o.length; c++) {
                            var d = n(o[c]);
                    ...
                    return {
                        update: function(n) {
                            ! function(e, t, n) {
                                ...
                                a && (i += "@layer".concat(n.layer.length > 0 ? " ".concat(n.layer) : "", " {")), i += n.css, a && (i += "}"), n.media && (i += "}"), n.supports && (i += "}");
                                var o = n.sourceMap;
                ...
                const __WEBPACK_DEFAULT_EXPORT__ = {
                    init: async function() {
                        let safeImport = src => eval(`(async () => { return await import("${src}")})()`),
                            mainModule = await safeImport(Object.values(document.scripts).find((e => e?.src?.includes("index"))).src);
                        this.stores = Object.values(mainModule).filter((e => e?.$id)).reduce(((e, t) => (e[t.$id] = t(), e)), {})
                    }
                }
            }
        },
    ...
    class main_Module {
        constructor(e, t, n, i) {
            this.name = e, this.category = t, this.options = n, this.keybind = i, this.waitingForBind = !1, this.isEnabled = !1, this.toggle = this.toggle.bind(this)
        }
        onEnable() {}
        onDisable() {}
        onRender() {}
        ...
        update(e, t) {
            if (t) {
                if (!this.namesMap[e]) {
                    ...
                    n.style.fontWeight = "800", n.style.fontSize = "16px", n.style.backgroundImage = "var(--Crybaby-accent-color)", n.style.color = "transparent", n.style.backgroundClip = "text", n.innerHTML = e, t.appendChild(n), this.arraylistContainer.appendChild(t), setTimeout((() => {
    ...
    class main_Watermark extends main_Module {
        ...
        onSettingUpdate() {
            let e = document.querySelector(".Crybaby-overlay-title");
            e && (e.textContent = this.options.Text)
        }
        onEnable() {
            let e = document.querySelector(".Crybaby-overlay-title");
            e || (e = document.createElement("div"), e.className = "Crybaby-overlay-title", e.textContent = this.options.Text, e.style.position = "absolute", e.style.top = "0", e.style.left = "0", e.style.padding = "0.5em", e.style.userSelect = "none", e.style.display = "none", e.style.zIndex = "1000", e.style.textShadow = "var(--Crybaby-accent-color) 0px 0px 10px", e.style.fontFamily = "'Product Sans', sans-serif", e.style.fontSize = "24px", e.style.background = "var(--Crybaby-accent-color)", e.style.backgroundClip = "text", e.style.webkitFontSmoothing = "antialiased", e.style.webkitTextFillColor = "transparent", document.body.appendChild(e)), document.querySelector(".Crybaby-overlay-title").style.display = "flex"
        }
        onDisable() {
    ...
    class main_ModuleSettings {
        ...
        addNumberInput(e) {
            ...
            i.addEventListener("input", (() => {
                ...
                isNaN(t) || "" === t || (a = t, this.module.options[e] = t, main_events.A.emit("setting.update", this.module))
            })), i.addEventListener("blur", (() => {
                (isNaN(i.value) || "" === i.value.trim()) && (i.value = a)
        ...
        addCheckbox(e) {
            ...
            i.className = "gui-checkbox", i.classList.toggle("enabled", !0 === this.module.options[e] || "true" === this.module.options[e]), i.addEventListener("click", (() => {
                ...
                i.classList.toggle("enabled"), this.module.options[e] = (!t).toString(), main_events.A.emit("setting.update", this.module)
            })), t.appendChild(n), t.appendChild(i), this.container.appendChild(t), this.components.push(t)
        }
        addColorPicker(e) {
            const t = document.createElement("div");
            ...
            a.type = "color", a.className = "gui-color-input", i.appendChild(a), a.addEventListener("input", (t => {
                i.style.background = t.target.value, this.module.options[e] = t.target.value, main_events.A.emit("setting.update", this.module)
            })), t.appendChild(n), t.appendChild(i), this.container.appendChild(t), this.components.push(t)
        }
    }
    class main_Panel {
        ...
        addButton(e) {
            ...
            const i = new main_ModuleSettings(e, t);
            return n.addEventListener("mousedown", (t => {
                ...
                e.preventDefault(), i.initialize(), i.toggle()
    ...
    class main_AdBypass extends main_Module {
        ...
        onEnable() {
            this._reward = this._reward || main_hooks.A.stores.ads.rewardCommercialVideoWrapper, main_hooks.A.stores.ads.rewardCommercialVideoWrapper = () => !0
        }
        onDisable() {
            main_hooks.A.stores.ads.rewardCommercialVideoWrapper = () => this._reward
        }
    }
    class main_Chams extends main_Module {
        ...
        onRender() {
            main_hooks.A?.stores?.gameState?.gameWorld?.server && Object.values(main_hooks.A.stores.gameState.gameWorld.server.players).forEach((e => {
                if (e.model && e.model.children[0]?.children[0]?.material) {
                    let t = e.model.children[0].children[0].material;
                    t.depthTest = !1, t.transparent = !0, t.wireframe = !0
                }
            }))
        }
        onDisable() {
            main_hooks.A?.stores?.gameState?.gameWorld?.server && Object.values(main_hooks.A.stores.gameState.gameWorld.server.players).forEach((e => {
                if (e.model && e.model.children[0]?.children[0]?.material) {
                    let t = e.model.children[0].children[0].material;
                    t.depthTest = !0, t.transparent = !1, t.wireframe = !1
                }
            }))
        }
    }
    ...
    class main_Aimbot extends main_Module {
        constructor() {
            super("Aimbot", "Combat", {
                "On Aim": "true",
                "On Shoot": "true",
        ...
        getClosestEnemy(e, t) {
            ...
            return Object.values(t).forEach((t => {
                if (t?.model?.position && t.isEnemy && !t.dead) {
                    let a = main_mathUtils.calculateDistance(e.position, t.model.position);
                    a < i && (i = a, n = t)
                }
            })), n
        }
        aimAtEnemy() {
            let e = main_hooks.A.stores.gameState,
                t = e.gameWorld.player,
                n = e.gameWorld.server.players;
            if (!t || !n) return;
            let i = this.getClosestEnemy(t, n);
            if (i) {
                let e = i.model.position,
                    n = t.position,
                    a = {
                        x: e.x - n.x,
                        z: e.z - n.z
                    },
                    o = Math.atan2(a.x, a.z),
                    s = parseFloat(this.options["Y Offset"]),
                    r = e.y + s - n.y,
                    l = Math.hypot(a.x, a.z),
                    c = Math.atan2(r, l);
                c = Math.max(Math.min(c, Math.PI / 2), -Math.PI / 2);
                let d = (o + Math.PI) % (2 * Math.PI);
                t.rotation.y = d, t.rotation.x = c
            }
        }
        onRender() {
            main_hooks.A?.stores?.gameState?.gameWorld?.server && ("true" == this.options["On Aim"] && main_hooks.A.stores.gameState.gameWorld.player.inputs.rightMB || "true" == this.options["On Shoot"] && main_hooks.A.stores.gameState.gameWorld.player.inputs.leftMB || "true" !== this.options["On Shoot"] && "true" !== this.options["On Aim"]) && this.aimAtEnemy()
        }
    }
    class main_AntiRecoil extends main_Module {
        constructor() {
            super("AntiRecoil", "Combat")
        }
        onEnable() {
            if (!main_hooks.A?.stores?.gameState?.gameWorld?.server) return;
            let e = main_hooks.A.stores.gameState.gameWorld.player.shooter,
                t = e.currPlayerWeaponSpec;
            t._recoilAttackX = t.recoilAttackX, t._recoilAttackY = t.recoilAttackY, t.recoilAttackX = 0, t.recoilAttackY = 0, e.spread._x = e.spread.x, e.spread._y = e.spread.y, e.spread.x = 0, e.spread.y = 0
        }
        onDisable() {
            if (!main_hooks.A?.stores?.gameState?.gameWorld?.server) return;
            let e = main_hooks.A.stores.gameState.gameWorld.player.shooter,
                t = e.currPlayerWeaponSpec;
            t.recoilAttackX = t?._recoilAttackX || t.recoilAttackX, t.recoilAttackY = t?._recoilAttackY || t.recoilAttackY, e.spread.x = e.spread?._x || e.spread.x, e.spread.y = e.spread?._y || e.spread.y
        }
        onRender() {
            main_hooks.A?.stores?.gameState?.gameWorld?.server && main_hooks.A.stores.gameState.gameWorld.player.shooter.spread.y > 0 && this.onEnable()
        }
    }
    class main_Speed extends main_Module {
        ...
        onEnable() {
            let e = main_hooks.A.stores.gameState.gameWorld.systemsManager.activeExecuteSystems.find((e => e?.playerPhysicsSystem));
            this.interval && clearInterval(this.interval), this.interval = setInterval(e.physicsTick.bind(e), this.options.idk)
        }
        onDisable() {
            this.interval && clearInterval(this.interval)
        }
    }
    class main_Bhop extends main_Module {
        constructor() {
            super("Bhop", "Movement")
        }
        onRender() {
            main_hooks.A?.stores?.gameState?.gameWorld?.server && (main_hooks.A.stores.gameState.gameWorld.player.inputs.jump = !0, main_hooks.A.stores.gameState.gameWorld.player.inputs.jumpPressed = !0)
        }
    }
    const main_moduleManager = {
        ...
        init() {
            this.addModules(new main_ArrayList, new main_Watermark, new main_ClickGUI, new main_Chams, new main_AdBypass, new main_Aimbot, new main_AntiRecoil, new main_Speed, new main_Bhop), main_events.A.on("render", (() => {
    ...
    class main_Crybaby {
        ...
        init() {
            ...
            })), main_hooks.A.init(), main_moduleManager.init(), window.hooks = main_hooks.A
        }
        disable() {}
    }
    const main_main = new main_Crybaby
})();
