...
factory: [{
            ...
            run: function(blookData) {
                ...
                if (targetObj) {
                    const chosenBlook = JSON.parse(blookData);
                    const maxSlots = 10;
            ...
            run: function() {
                ...
                if (foundFactories) {
                    foundFactories.forEach(factory => factory.level = 4);
                }
            }
        }, {
                    ...
                    if (reactKey) {
                        try {
                            ...
                            while (fiber) {
                                if (fiber._owner && fiber._owner.stateNode && fiber._owner.stateNode.state) {
                                    const state = fiber._owner.stateNode.state;
                                    if (state.bits !== undefined) return fiber._owner.stateNode;
                                }
                                if (fiber.stateNode && fiber.stateNode.state) {
                                    const state = fiber.stateNode.state;
                                    if (state.bits !== undefined) return fiber.stateNode;
                                }
                                fiber = fiber.return;
                            }
                        } catch (e) {}
                ...
                function searchDOM(element = document.body, depth = 0) {
                    ...
                    if (reactKey) {
                        try {
                            let fiber = element[reactKey];
                            while (fiber) {
                                if (fiber._owner && fiber._owner.stateNode && fiber._owner.stateNode.props) {
                                    const props = fiber._owner.stateNode.props;
                                    if (props.liveGameController && props.client) return fiber._owner.stateNode;
                                }
                                if (fiber.stateNode && fiber.stateNode.props) {
                                    const props = fiber.stateNode.props;
                                    if (props.liveGameController && props.client) return fiber.stateNode;
                                }
                                fiber = fiber.return;
                            }
                        } catch (e) {}
            ...
            run: function() {
                ...
                if (targetObj) {
                    targetObj.factories = Array(10).fill({
                        name: "Mega Bot",
                        color: "#d71f27",
                        class: "🤖",
                        rarity: "Legendary",
                    ...
                    if (reactKey) {
                        try {
                            ...
                            while (fiber) {
                                if (fiber._owner && fiber._owner.stateNode && fiber._owner.stateNode.state) {
                                    const state = fiber._owner.stateNode.state;
                                    if (state.cash !== undefined) return fiber._owner.stateNode;
                                }
                                if (fiber.stateNode && fiber.stateNode.state) {
                                    const state = fiber.stateNode.state;
                                    if (state.cash !== undefined) return fiber.stateNode;
                                }
                                fiber = fiber.return;
                            }
                        } catch (e) {}
