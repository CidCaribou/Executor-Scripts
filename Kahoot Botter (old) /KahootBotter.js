...
title.textContent = 'Loading Hack...';
...
const loadHTMLContent = async (url) => {
  try {
    ...
    title.textContent = 'Kahoot Botter';
  } catch (error) {
    alert('Error loading Hack:', error);
    title.textContent = 'Error Loading Hack';
  }
};

const htmlFileURL = 'https://cdn.jsdelivr.net/gh/CidCaribou/Executor-Scripts@refs/heads/main/Kahoot%20Botter/index.html';
